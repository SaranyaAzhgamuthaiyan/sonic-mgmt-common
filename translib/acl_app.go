...
func (app *AclApp) translateMDBReplace(numDB db.NumberDB) ([]db.WatchKeys, error) {
	return nil, tlerr.NotSupported("Unsupported")
}

func (app *AclApp) translateMDBGet(mdb db.MDB) error {
	return tlerr.NotSupported("Unsupported")
}

func (app *AclApp) translateGetRegex(mdb db.MDB) error  {
	return tlerr.NotSupported("Unsupported")
}

func (app *AclApp) processMDBReplace(numDB db.NumberDB) (SetResponse, error) {
	return SetResponse{}, tlerr.NotSupported("Unsupported")
}

func (app *AclApp) processMDBGet(mdb db.MDB) (GetResponse, error) {
...
func (app *AclApp) translateAction(mdb db.MDB) error {
...
func (app *AclApp) processGetRegex(mdb db.MDB) ([]GetResponseRegex, error) {
	var err error
	return nil, err
}

func (app *AclApp) processAction(mdb db.MDB) (ActionResponse, error) {
